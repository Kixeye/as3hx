...
class Compat {
    ...
    macro public static function parseFloat<T>(e:ExprOf<T>):ExprOf<T> {
        ...
        return switch(type) {
            case "Float" | "KxFloat" | "Int": macro ${e};
    ...
    macro public static function parseInt<T>(e:ExprOf<T>, ?base:ExprOf<Int>):ExprOf<T> {
        ...
        return switch(type) {
            case "Int": macro ${e};
            case "Float" | "KxFloat": macro Std.int(${e});
    ...
    static function _parseInt(s:String, ?base:Int):Null<Int> {
        ...
        var v:Int = untyped js.Syntax.code("parseInt")(s, base);
    ...
    public static inline function setInterval(closure:Dynamic, delay:Int, ?values:Array<Dynamic>):Int {
        ...
        #elseif js
        return untyped js.Syntax.code('setInterval')(closure, delay, values);
        #elseif (haxe_ver >= "3.3")
    ...
    public static inline function clearInterval(id:Int) {
        ...
        #elseif js
        untyped js.Syntax.code('clearInterval')(id);
        #elseif (haxe_ver >= "3.3")
    ...
    public static inline function setTimeout(closure:Dynamic, delay:Int, ?values:Array<Dynamic>):Int {
        ...
        #elseif js
        return untyped js.Syntax.code('setTimeout')(closure, delay, values);
        #elseif (haxe_ver >= "3.3")
        if (values == null) values = [];
